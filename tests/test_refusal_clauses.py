...
def test_the_policed_population_is_derived_from_the_tree_and_has_not_grown_silently():
    ...
    assert len(POLICED) == 115, sorted(POLICED)
...
RECORDED_CLAUSES = [
    'above_one', 'adjacent_pair_shapes_differ', 'allowlist_name_pattern',
    'alpha_declaration_missing', 'alpha_disagrees_with_the_file', 'anchor_not_a_number',
    'anchor_not_a_pair', 'anchor_outside_unit_interval', 'arc_did_not_survive',
    'arc_does_not_move', 'arm_input_missing', 'arm_not_in_experiment',
    'asset_has_no_evaluated_geometry', 'asset_imported_no_mesh_objects',
    'atlas_has_no_pixels', 'attribution_cannot_reach_the_gate_that_checks_it',
    'attribution_for_unconditional_row', 'authoring_rate_not_positive', 'bad_magic',
    'band_too_narrow', 'banned_component_in_base', 'batch_node_is_not_a_batch',
    'batch_node_over_the_slot_ceiling', 'bisect_target_not_finite', 'bit1_not_grayscale',
    'bit1_values', 'bit8_dtype', 'blend_band_not_positive', 'blocked_addition',
    'blocked_addition_empty', 'blocked_addition_phrase', 'blocked_addition_shape',
    'blocked_additions_not_a_list', 'body_keypoints_wrong_shape',
    'bone_has_an_unknown_rule', 'bone_has_no_model_rule',
    'bone_has_no_registered_cross_section', 'bone_has_zero_rest_length',
    'bone_radius_not_positive', 'bone_set_changes_between_frames',
    'bufferview_negative_range', 'bufferview_no_bytelength', 'bufferview_not_an_index',
    'bufferview_out_of_range', 'bufferview_past_bin_chunk',
    'cadence_outruns_frame_rate_at_a_stance_exchange', 'camera_widget_order',
    'candidate_frames_are_not_all_one_size', 'cap_below_the_bbox_corners',
    'cap_would_loosen_the_module_ceiling', 'census_is_not_a_mapping',
    'centreline_has_zero_length', 'centroids_not_n_by_3', 'channel_is_zero_bytes',
    'channel_never_reached_disk', 'checkbox', 'child_bone_has_no_length',
    'class_not_named_by_the_allowlist', 'class_with_an_unreadable_measurement_date',
    'class_without_a_recorded_free_measurement', 'clip_end_is_closer_than_the_subject',
    'clip_would_be_written_outside_out', 'compensator_target_carries_no_run_marker',
    'composite_colour_carries_a_non_number', 'composite_colour_not_linear_unit_floats',
    'composite_colour_not_three_floats', 'composition_puts_points_behind_the_camera',
    'composition_unreachable', 'conditional_tier_without_its_readers',
    'convention_nonconformance', 'convention_pin_disagrees',
    'converted_widget_shifts_enum_indices', 'converted_widget_shifts_recorded_indices',
    'corner_classified_as_subject', 'cover', 'cover_crop_produced_the_wrong_size',
    'create_video_fps', 'cv2_could_not_read_the_source', 'cv2_refused_the_frame_write',
    'cv2_refused_the_strip_write', 'cv2_refused_the_write',
    'declared_group_size_above_the_ceiling', 'declared_total_disagrees',
    'decode_stride_is_not_positive', 'decoded_bytes_are_not_whole_frames',
    'decoded_rate_disagrees_with_the_declaration', 'decoded_rate_not_finite',
    'degenerate_bounding_box', 'degenerate_plate', 'degenerate_target_frame',
    'depth_buffer_is_not_the_frame_size', 'destination_frame_count_below_two',
    'diagnostic_cannot_be_armed', 'downloader_job_exits',
    'drawing_constant_outside_the_record', 'drawing_convention_not_retrieved',
    'duplicate_link_id', 'duplicate_socket_name', 'duplicate_subgraph_id',
    'duplicate_subgraph_label', 'empty_expectation', 'empty_gradient_band',
    'empty_graph', 'empty_keypoint_population', 'empty_point_cloud', 'empty_prompt',
    'empty_reference', 'empty_results', 'empty_set', 'encode_rate_not_positive',
    'engine', 'escape', 'escape_no_subject', 'escape_unknown',
    'every_imported_mesh_is_hidden_from_render', 'every_point_behind_the_camera',
    'expectation_carries_a_duplicated_frame', 'expectation_is_not_the_frame_list',
    'expected_rate_not_finite', 'expected_rate_not_positive', 'extent_over_zero_points',
    'extraction_left_no_faces', 'ffmpeg_binary_not_found', 'ffmpeg_refused_the_decode',
    'ffmpeg_refused_the_encode', 'field_absent', 'field_disagrees',
    'fit_disagrees_with_the_file', 'flag_component_not_an_integer',
    'forbidden_not_a_list', 'forbidden_word', 'frame_absent_from_manifest',
    'frame_and_predecessor_are_different_sizes', 'frame_array_shape_is_not_a_frame',
    'frame_array_shape_is_unsupported', 'frame_carries_an_alpha_channel',
    'frame_dtype_is_not_uint8', 'frame_form', 'frame_hints_are_parallel',
    'frame_index_not_an_integer', 'frame_index_not_in_the_clip',
    'frame_index_outside_the_record', 'frame_is_colour_not_grayscale',
    'frame_is_missing_a_bone', 'frame_is_not_eight_bit', 'frame_is_palette_indexed',
    'frame_list_is_empty', 'frame_names_are_not_a_fixed_width', 'frame_not_hw3',
    'frame_not_three_integers', 'frame_size_not_positive', 'frame_source_not_callable',
    'frame_source_not_reiterable', 'frame_triple', 'frame_type',
    'frame_zero_carries_no_bones', 'frames_and_out_are_required',
    'frames_are_not_all_one_size', 'frames_are_not_contiguous',
    'frames_dir_is_not_a_directory', 'frames_without_index', 'gate_l_frame_source',
    'gate_s_registration', 'gated_text_is_not_shipped_text', 'graph_file_missing',
    ...
    'hinge_hint_is_parallel_to_the_bone', 'hosted_enum_widgets_truncated',
    'identity_only', 'import', 'interior_sample_past_the_span',
    'keypoint_outside_the_frame', 'keypoint_value_is_not_a_number',
    'landmark_list_is_partial', 'landmark_table_renamed', 'landmarks_missing',
    'length_mismatch', 'licence_map_ruling', 'limb_column_is_discontinuous',
    'limb_trace_too_short', 'masked_geometry_is_all_background_depth',
    'measurement_dated_in_the_future', 'measurement_not_positive',
    'meta_path_equals_graph_path', 'min_frac_may_only_tighten', 'missing_arm_input',
    'missing_file', 'missing_or_empty', 'missing_prompt', 'missing_required',
    'missing_subject', 'missing_upload_key', 'mitten_hand_wrong_point_count',
    'motion_record_has_no_frames', 'multiple_graph_declarations',
    'no_batch_node_to_measure', 'no_camera_block', 'no_candidate_frames',
    'no_composite_colour_named', 'no_corner_is_inside_the_subject_mask',
    'no_deforming_bones', 'no_distribution_to_summarise',
    'no_foot_vertices_below_the_ankle', 'no_frame_carries_a_measurable_leg',
    'no_frames_to_gate', 'no_head_vertices_above_the_head_base', 'no_json_chunk',
    'no_keyed_action', 'no_legal_clauses', 'no_moving_frames',
    'no_neck_between_two_wider_sections', 'no_numbered_frames_in_the_directory',
    'no_numbered_frames_to_encode', 'no_numbered_frames_to_invert',
    'no_numbered_frames_to_measure', 'no_parts_to_assign_to', 'no_points_given',
    'no_positive_joint_radius', 'no_pre_export_snapshot', 'no_pre_render_snapshot',
    'no_render_visible_mesh', 'no_seed_and_no_registration',
    'no_slab_to_read_facing_from', 'no_steps', 'no_surfaces',
    'no_trace_to_size_a_ball_against', 'no_trace_to_size_a_bone_against',
    'no_vertices_to_frame', 'no_views', 'node_map_duplicate_id', 'node_map_empty',
    'node_map_entry_empty_side', 'node_map_entry_shape', 'node_without_a_class_type',
    'non_finite_depth_window', 'non_finite_geometry_depth', 'non_finite_geometry_normal',
    'non_finite_pair_distance', 'not_a_finite_angle', 'not_a_finite_fraction',
    'not_a_finite_positive_fraction', 'not_a_flag', 'not_a_rotation',
    'not_a_save_format_graph', 'not_an_api_format_graph', 'not_api_format', 'not_object',
    'numpy_unavailable', 'observed_sites_missing', 'operator_status', 'orbit radius',
    'order_unvouched', 'orphaned_component_class_alias', 'ortho_scale',
    'ortho_scale_not_finite_positive', 'ortho_scale_not_positive',
    'ortho_scale_pin_not_finite_and_positive', 'ortho_scale_pin_on_a_perspective_plan',
    'ortho_scale_pinned_without_ortho', 'out_dir_is_not_a_directory',
    'out_dir_not_empty', 'output_name_is_not_a_name', 'pack_rate_not_positive',
    'palm_plane_degenerate', 'panels_document_is_missing_a_key',
    'panels_document_is_not_an_object', 'panels_document_is_not_on_disk',
    'panels_document_not_named', 'part_radius_not_positive',
    'phase_shorter_than_a_frame', 'pixels_not_a_plane', 'pixels_unreadable',
    'plan_paths_collide', 'plate_component_not_an_integer',
    'plate_component_out_of_range', 'plate_not_three_components', 'plate_source_missing',
    'playback_rate_not_finite', 'playback_rate_not_positive', 'points_behind_the_camera',
    'population_is_not_the_spec_names', 'preview_frame_collapsed',
    'previz_frame_could_not_be_decoded', 'previz_frame_is_not_on_disk',
    'radius_bounds_not_an_interval', 'radius_bounds_not_finite_and_positive',
    'radius_not_a_distance', 'ranges_differ', 'readout_angle_outside_the_arc',
    'record_carries_a_caught_refusal', 'record_carries_no_verify_receipt',
    'record_describes_a_different_graph', 'record_frame_counts_disagree',
    'record_route_facts_disagree', 'record_unreadable',
    'recorded_convention_digest_drift', 'reference_clip_has_no_frames',
    'reference_file_missing', 'reference_file_not_a_png',
    'reference_fit_has_no_recorded_assertion', 'reference_not_a_file',
    'reference_unreadable', 'registration_inconsistent', 'render visibility',
    'render_and_keypoints_disagree_on_resolution', 'render_target_missing',
    'request_overruns_the_performance', 'required_landmark_missing',
    'rest_landmarks_missing', 'root_is_not_a_3_vector', 'run_manifest_is_missing_a_key',
    'run_manifest_is_not_on_disk', 'sample_component_not_an_integer',
    'sample_frame_not_in_the_extraction', 'sample_index_is_negative',
    'sample_names_no_frames', 'sampled_window_outside_the_keys',
    'scene_fps_disagrees_with_the_shot', 'schema', 'seed_not_registered',
    'segment_has_zero_length', 'set_short', 'shape_mismatch', 'short_chunk_body',
    'short_chunk_header', 'short_header', 'sign_not_unit',
    'silhouette_does_not_clear_the_border', 'silhouette_is_not_a_standing_figure',
    'site_registration_invalid', 'snappable_site_is_not_a_landmark',
    'source_has_no_faces', 'source_image_has_a_zero_dimension',
    'source_rate_not_positive', 'spec_or_asset_path_unreadable', 'stale_channel',
    'stale_consumer', 'stale_render_target', 'stale_target', 'stance_frac_not_modelled',
    'stance_frac_outside_0_1', 'start_frame_not_a_png', 'start_frame_unmeasured',
    'stats_document_is_missing_a_key', 'stray_png_in_the_frame_population',
    'stream_reported_no_rate', 'strip_stride_not_positive', 'subject_args',
    'subject_list_is_empty', 'subject_not_in_the_canon_census',
    'subject_panel_is_not_on_disk', 'subject_stats_sidecar_is_not_on_disk',
    'survey_panel_is_not_on_disk', 'sweep_revisits_an_azimuth', 'target_not_a_3_vector',
    'tolerance_not_finite', 'too_few_bands_for_a_centreline',
    'too_few_destination_samples', 'too_few_frames_for_a_second_difference',
    'too_few_frames_for_an_arc', 'too_few_leg_bands_for_an_ankle',
    'too_few_phase_samples', 'too_few_points_for_a_sphere_fit', 'too_few_source_samples',
    'too_few_vertices_for_bands', 'trunk_column_too_short', 'trunk_holds_no_clusters',
    'twist_datum_collapsed', 'two_answers', 'unexpected_source_node', 'unknown_arm',
    'unknown_axis', 'unknown_bone', 'unknown_codec', 'unknown_experiment',
    'unknown_flag', 'unknown_generator_family', 'unknown_hosted_tier',
    'unknown_pose_arc', 'unknown_spec_key', 'unknown_stickwidth_type', 'unknown_subject',
    'unparseable_file', 'unratified_only', 'unreadable', 'unreadable_landmark_row',
    'unreadable_node', 'unreadable_shape', 'unsupported_bit_depth', 'unsupported_shape',
    'unsupported_version', 'vector_has_zero_length', 'verify_receipt_missing_its_facts',
    'vertices_not_n_by_3', 'video_nodes_empty', 'view_count_not_positive',
    'view_direction_parallel_to_up', 'view_without_a_digest', 'views_byte_identical',
    'views_identical_in_pixels', 'views_identical_in_pixels_anywhere',
    'views_without_pixels', 'visible_rows_component_not_an_integer',
    'visible_rows_not_a_band_inside_the_frame', 'voxel_not_finite_and_positive',
    'why_not_supplied', 'world_bounds_without_scene', 'write', 'zero_dimension',
    'zero_length_direction', 'zero_length_geometry_normal', 'zero_quaternion',
]
...
CLAUSES_NAMED_BY_NO_FIXTURE = [
    'allowlist_name_pattern', 'anchor_not_a_number', 'anchor_not_a_pair',
