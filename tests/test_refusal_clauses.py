...
RECORDED_CLAUSES = [
    ...
    'out_dir_not_empty',
    'out_given_twice',
    # WAVE 28 (instruments, F-8b7f48a8): ONE word for the silent-overwrite family at both
    # of its anchors — this domain's three renderers and builders' payload builders (SEAM 1
    # in `wave-28/seams-inbox.md` agreed the flag `--overwrite`, this word, the sentence
    # and the two record keys). If builders spells the same word, the vocabulary gains one
    # entry, not two.
