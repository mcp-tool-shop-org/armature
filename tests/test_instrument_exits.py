...
RECORDED_CPYTHON_WITH_HANDLER = [
    ...
    "build_payload.py", "build_r2v_payload.py", "build_routes_payload.py",
    "build_submit_payload.py", "build_t2v_payload.py", "build_uploads_payload.py",
    "canon_gate.py",
...
def test_the_one_handlers_adopters_are_derived_and_carry_the_six_key_record():
    ...
    assert adopters == [
        ...
        "build_r2v_payload.py", "build_routes_payload.py", "build_submit_payload.py",
...
def test_the_cpython_derivation_reads_the_prefix_and_the_entry_off_the_block():
    ...
    **WAVE 25: the same five, out of 54 rather than 25, and the point is sharper for it.**
    ...
    # WAVE 35: 49 -> 50. build_routes_payload joins the same way.
    assert len(CPYTHON_WITH_HANDLER) - len(by_stem) == 50, len(CPYTHON_WITH_HANDLER)
