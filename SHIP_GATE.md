...
> exist, `armature` is a console script, and **v0.4.0 is on PyPI and npm** (registry APIs,
...
>
> The version target is **v0.x** (first marked state v0.1.0, current **v0.4.0**), which
