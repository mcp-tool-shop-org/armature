...
| Pruebas | **8051: superación de las pruebas en el entorno de pruebas** (59 pruebas omitidas, medidas el 7 de septiembre de 2026 después de la corrección del pin de ejecución de la función — 7538 en v0.4.0, 7811 después de la etapa D), idéntico en `-O` durante la prueba que registró el ESTADO; las pruebas de CI evalúan lo que realmente puede hacer un ejecutor: los recursos locales del entorno de pruebas **se omiten de forma visible**. |
| Estado | **v0.5.0** — mejoras visuales de la etapa D y una nueva función basada en la ejecución de pruebas de salud de v0.4.0. Se autorizó la inclusión en el repositorio (`build_submit_payload.py`, prueba en seco), se instaló la CLI `canon` / `verify` / `spec` / `donor`, 8051 pruebas. No es la versión 1.0.0: el elemento pendiente sigue abierto. |
