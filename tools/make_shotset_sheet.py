...
def _cli(argv=None):
    ...
    `main()`. `tests/test_make_shotset_sheet.py` drives `main(argv)` directly, so the
    signature and the return stay exactly as they are.
...
if __name__ == "__main__":
    ...
    run_tool_main(_cli, "MAKE_SHOTSET_SHEET")
