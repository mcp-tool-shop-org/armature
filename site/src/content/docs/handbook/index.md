...
**v0.5.0 is Stage D plus the feature pass.** A sanctioned in-repo submitter sits on the spend
(`tools/build_submit_payload.py`, dry-run, no live credits in the suite). The installed CLI
grew `canon`, `verify`, `spec check`, `donor check`. The suite is **8051 passed / 59 skipped**
(2026-09-07). Not 1.0.0: filled is still open.
